...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'agreeTerms' => [parent::class, 'agreeTerms', null],
        ...
        "\0".parent::class."\0".'evenementsInscrits' => [parent::class, 'evenementsInscrits', null],
