...
class __TwigTemplate_dcd9ba074add96e17e62aad7017deefa extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 15
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_modifprofile", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "user", [], "any", false, false, false, 15), "id", [], "any", false, false, false, 15)]), "html", null, true);
        yield "\">Modifier Profile</a>
    <a href=\"";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_modifmdp", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "user", [], "any", false, false, false, 16), "id", [], "any", false, false, false, 16)]), "html", null, true);
        yield "\">Modifier Mdp</a>
...
";
    ...
    {
        return array (  98 => 16,  94 => 15,  88 => 12,  84 => 11,  80 => 10,  75 => 7,  68 => 5,  54 => 3,  37 => 1,);
    }
...
{% block body %}
{#    <a href=\"{{ path(\"app_admin\") }}\">Acceuil</a>#}


    <div class=\"example-wrapper\">
        <h1>Nom: {{ app.user.nom }}</h1>
        <h1>Prenom: {{ app.user.prenom }}</h1>
        <h1>Email: {{ app.user.email }}</h1>

    </div>
    <a href=\"{{ path(\"app_modifprofile\", {id:app.user.id}) }}\">Modifier Profile</a>
    <a href=\"{{ path(\"app_modifmdp\", {id:app.user.id}) }}\">Modifier Mdp</a>

{% endblock %}
", "admin/profile.html.twig", "/home/redha/Documents/web/phpAvanceS6/php_project/templates/admin/profile.html.twig");
    }
}
